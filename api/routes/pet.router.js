...
const { getAllPets, getPetById, savePet, updatePet, deletePet, deleteNoteFromPet, getNotesFromPet, addNoteToPet,addCaseInPet, viewVitalsPet, viewTestsPet, createNoteToPet } = require('../controllers/pet.controller')
